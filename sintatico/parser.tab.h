...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    GENERAL = 282,                 /* GENERAL  */
    HAS = 283,                     /* HAS  */
    NATIVE_TYPE = 284,             /* NATIVE_TYPE  */
    CLASS_STEREOTYPE = 285,        /* CLASS_STEREOTYPE  */
    MATERIAL = 286,                /* MATERIAL  */
    RELATION_STEREOTYPE = 287,     /* RELATION_STEREOTYPE  */
    NUM = 288,                     /* NUM  */
    ID = 289,                      /* ID  */
    CARDINALITY = 290,             /* CARDINALITY  */
    EMPTY = 291                    /* EMPTY  */
  };
